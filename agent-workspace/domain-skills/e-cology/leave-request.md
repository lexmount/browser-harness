...
Field-tested against enterprise.e-cology.com.cn on 2026-07-04（workflowid=243 员工请假流程，formid=180，创建节点 nodeid=1878）。
...
**演示账号（杨文元）的事假/病假/调休余额为 0，提交会被 HRM 校验拦下**（"可请带薪假天数为0，不能请带薪假！"）。**用探亲假 `5`（或婚假 `7`、丧假 `10`）——这类无余额校验，可直接提交成功。**
